...
let g:colors_name="red2"

if &t_Co > 255
  hi Normal         term=none cterm=none ctermfg=59   ctermbg=232
  hi Boolean        term=none cterm=none ctermfg=9    ctermbg=none
  hi Character      term=none cterm=none ctermfg=38   ctermbg=none
  ...
  hi Float          term=none cterm=none ctermfg=141  ctermbg=none
  ...
  hi LineNr         term=none cterm=none ctermfg=235  ctermbg=232
  ...
  hi PreCondit      term=none cterm=none ctermfg=243  ctermbg=none
  hi PreProc        term=none cterm=none ctermfg=243  ctermbg=none
  hi Question       term=none cterm=none ctermfg=15   ctermbg=none
  hi Repeat         term=none cterm=none ctermfg=110  ctermbg=none
  hi Search         term=none cterm=none ctermfg=9    ctermbg=none
  hi SpecialChar    term=none cterm=none ctermfg=39   ctermbg=none
  ...
  hi String         term=none cterm=none ctermfg=148  ctermbg=none
  hi Structure      term=none cterm=none ctermfg=253  ctermbg=none
